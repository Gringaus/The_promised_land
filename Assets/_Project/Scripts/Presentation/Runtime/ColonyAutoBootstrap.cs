...
namespace FoundersLands.Presentation
{
    ...
    /// and <see cref="ColonyDebugOverlay"/> on play if the scene has none — so any scene runs the
    /// simulation with no manual setup. Off by default; without the define nothing happens.
    /// </summary>
    public static class ColonyAutoBootstrap
    {
        ...
        private static void SpawnIfAbsent()
        {
            ...
            go.AddComponent<ColonyDebugOverlay>();
