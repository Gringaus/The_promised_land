...
Тесты: **49 проходящих юнит-тестов** (детерминизм карты/симуляции/стройки, границы значений,
...
| MVP (§24.1) | Ресурсы, жители, склады, сезоны, выживание ✓ · строительство ✓ · сохранение — далее | **в работе** |
