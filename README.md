...
Тесты: **41 проходящий юнит-тест** (детерминизм карты и симуляции, границы значений,
согласованность воды/биомов, правила ресурсов, инвентарь/спойл, сезоны, сценарии выживания).
